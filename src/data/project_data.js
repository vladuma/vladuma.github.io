module.exports = [
    ...
    },
    {
      ...
      type: 'react',
      description: 'A simple app built with React + Redux and Firebase backend',
      tags: ['React', 'Redux', 'Firebase', 'Webpack'],
      link: 'https://bookmark-app-ff6b2.web.app/',
    ...
    },
    {
      ...
      tags: ['HTML', 'CSS', 'WordPress', 'JavaScript', 'jQuery', 'PHP'],
